...
\begin{abstract}\strut
  ...
  \TeX\ FAQ (\nolinkurl{https://texfaq.org/}).  Rather than require
  the user to formulate a query, it merely presents examples of
  customized \LaTeX{} formatting---and formatting problems---encased
  in live hyperlinks (green or red, as appropriate) to appropriate
  pages in the FAQ\@.  The goal is to facilitate finding answers to
  \LaTeX-related queries which are difficult to formulate textually
  but easy to recognize visually.
